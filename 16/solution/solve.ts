...
// 
    ...
    opts.sort((a, b) => {
      ...
      const pota = a.total + (a.mins - a.deltaMe) * (a.p + map.get(a.meTarget).rate)
      const potb = b.total + (b.mins - b.deltaMe) * (b.p + map.get(b.meTarget).rate)


      if (a.meTarget === 'JJ' && b.meTarget === 'DD') {
        console.log(a, pota);
        console.log(b, potb);
